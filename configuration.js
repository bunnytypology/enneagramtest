...
questions = [
    ...
    {
      "description": "I am naturally empathetic.",
        "weights": {
            "Type 2": 4
        }
    },
    ...
    {
      "description": "I am generous and kind.",
        "weights": {
            "Type 2": 4
        }
    },
    ...
    {
      "description": "I frequently find myself rescuing others.",
        "weights": {
            "Type 2": 4
        }
    },
    ...
    {
       "description": "I enjoy being the center of attention in social settings.",
        "weights": {
            "Type 3": 4
        }
    },
    ...
    {
       "description": "I enjoy showing my individuality to others.",
        "weights": {
            "Type 4": 4
        }
    },
    ...
    {
       "description": "I am a nostalgic person.",
        "weights": {
            "Type 4": 4
        }
    },
    ...
    {
       "description": "I need to know everything about something to be confident in my assessments.",
        "weights": {
            "Type 5": 4
        }
    },
    ...
    {
       "description": "I tend to go on rambles when I talk to others about something I'm interested in.",
        "weights": {
            "Type 5": 4
        }
    },
    ...
    {
       "description": "I mimic others I’m trying to befriend.",
        "weights": {
            "Type 6": 4
        }
    },
    ...
    {
       "description": "I have a hard time staying focused on one thing.",
        "weights": {
            "Type 7": 4
        }
    },
    {
       "description": "I feel understimulated unless I am doing many things at once.",
        "weights": {
            "Type 7": 4
        }
    },
    ...
    {
       "description": "I have problems saving things for later.",
        "weights": {
            "Type 7": 4
        }
    },
    ...
    {
       "description": "I am easily distracted.",
        "weights": {
            "Type 7": 4
        }
    },
    ...
    {
       "description": "I speak very directly.",
        "weights": {
            "Type 8": 4
        }
    },
    ...
    {
       "description": "I enjoy being defiant.",
        "weights": {
            "Type 8": 4
        }
    },
    ...
    {
       "description": "I deal with my problems head-on.",
        "weights": {
            "Type 8": 4
        }
    },
    ...
    {
        "description": "I am conflict-avoidant.",
        "weights": {
            "Type 9": 4
        }
    },
